...
# with open("data/processed/benchmark_open_filtered.json", "w") as f:
#     json.dump(benchmark_open_filtered, f, indent=4)

# print("Open-ended datasets saved to data/processed/benchmark_open_filtered.json")
